package com.example.qnectedlogin;
...
import com.example.qnectedlogin.databinding.ActivityMainBinding;
import com.example.qnectedlogin.databinding.ActivityQloginBinding;
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if(task.isSuccessful() && !task.getResult().isEmpty()){
                            ...
                            if (isPasswordCorrect){
                                ...
                                Intent intent = new Intent(QLogin.this, SiswaDashB.class);
                                startActivity(intent);
                            }else{
